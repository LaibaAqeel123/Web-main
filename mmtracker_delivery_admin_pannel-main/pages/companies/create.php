...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name)) {
        ...
        $query = "INSERT INTO Companies (name, phone, email, address, total_riders_allowed, default_requires_image_proof, default_requires_signature_proof) 
                  VALUES (?, ?, ?, ?, ?, ?, ?)";
        
        $stmt = mysqli_prepare($conn, $query);
        mysqli_stmt_bind_param($stmt, "ssssiii", $name, $phone, $email, $address, $total_riders_allowed, $default_requires_image_proof, $default_requires_signature_proof);
...
$formData = [
    ...
    'email' => '',
    'address' => '',
    'total_riders_allowed' => 5, // Default value
    'default_requires_image_proof' => 1, // Default to true
    'default_requires_signature_proof' => 1 // Default to true
];
?>
            ...
            <form action="" method="POST">
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" required 
                           ...
                           placeholder="Enter company name" value="<?php echo htmlspecialchars($formData['name']); ?>">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="phone" id="phone"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                           placeholder="Enter phone number" value="<?php echo htmlspecialchars($formData['phone']); ?>">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                           placeholder="Enter email address" value="<?php echo htmlspecialchars($formData['email']); ?>">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="address" id="address" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                              placeholder="Enter company address"><?php echo htmlspecialchars($formData['address']); ?></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="total_riders_allowed" id="total_riders_allowed"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                           placeholder="Enter maximum number of riders" value="<?php echo htmlspecialchars($formData['total_riders_allowed']); ?>">
                </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="default_requires_image_proof" name="default_requires_image_proof" type="checkbox" value="1"
                                       ...
                                       <?php echo $formData['default_requires_image_proof'] ? 'checked' : ''; ?>>
                            </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="default_requires_signature_proof" name="default_requires_signature_proof" type="checkbox" value="1"
                                       class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
                                       <?php echo $formData['default_requires_signature_proof'] ? 'checked' : ''; ?>>
                            </div>
                            <div class="ml-3 text-sm">
