            ...
            try {
                switch ($action) {
                    ...
                    case 'add_orders':
                        ...
                        $update_product_order_sql = "UPDATE ProductOrders SET picked_quantity = ?, missing_quantity = ? WHERE order_id = ? AND product_id = ?";
                            ...
                            if ($is_rider_delivering && !empty($rider_extras)) {
                                ...
                                while ($product = mysqli_fetch_assoc($result_order_prods)) {
                                    ...
                                    if (isset($rider_extras[$product_id]) && $rider_extras[$product_id] > 0) {
                                        ...
                                        if ($allocate_now > 0) {
                                            // Update ProductOrder: set picked_quantity and missing_quantity
